...
if selected_stock and selected_stock not in compare_symbols:
    ...
    if compare_symbols:
        if len(compare_symbols)==1:
            ...
            if not hist_data.empty and hist_data.shape[0]>=20:
                ...
                addplots=[]
                if 'SMA_20' in hist_data and hist_data['SMA_20'].notna().any(): addplots.append(mpf.make_addplot(hist_data['SMA_20'],color='orange'))
                if 'EMA_20' in hist_data and hist_data['EMA_20'].notna().any(): addplots.append(mpf.make_addplot(hist_data['EMA_20'],color='cyan'))
                if 'RSI' in hist_data and hist_data['RSI'].notna().any(): addplots.append(mpf.make_addplot(hist_data['RSI'],panel=1,color='purple',ylabel='RSI'))
                if 'MACD' in hist_data and hist_data['MACD'].notna().any(): addplots.append(mpf.make_addplot(hist_data['MACD'],panel=2,color='blue',ylabel='MACD'))
                if 'MACD_Signal' in hist_data and hist_data['MACD_Signal'].notna().any(): addplots.append(mpf.make_addplot(hist_data['MACD_Signal'],panel=2,color='orange'))
                ...
                st.warning("Not enough data to plot candle chart.")
        else:
            plt.close('all')
